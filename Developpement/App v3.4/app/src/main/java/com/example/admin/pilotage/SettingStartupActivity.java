        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    /*** video codec ******/
//                    for(int iBcl = 0; iBcl < 5; iBcl ++) {
                        mDrone.SendCMD("AT*CONFIG=" + mPilot.RecupSequenceNum(1) + ",\"video:video_codec\",\"136\"");
                        TimeUnit.MILLISECONDS.sleep(20);
//                    }
                ...
                Intent mIntent = new Intent(SettingStartupActivity.this, MainActivityPilotage.class);
